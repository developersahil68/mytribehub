      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-sky-600 font-bold text-xl">M</span>
              </div>
              <h3 className="text-xl font-bold">MyTribeHub</h3>
            </div>
        ...
        <div className="border-t border-sky-700 mt-8 pt-8 text-center">
          <p className="text-sky-200">
            © 2024 MyTribeHub. All rights reserved. | Privacy Policy | Terms of
            Service
          </p>
        </div>
      </div>
